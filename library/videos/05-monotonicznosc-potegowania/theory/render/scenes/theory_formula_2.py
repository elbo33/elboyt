...
DATA = json.loads("{\"tag\":\"WZÓR\",\"title\":\"Monotoniczność dla podstawy 0 < a < 1\",\"lines\":[\"0<a<1 \\\\;\\\\Longrightarrow\\\\; \\\\big(x_1<x_2 \\\\iff a^{x_1}>a^{x_2}\\\\big)\",\"0 < a < 1, x_1, x_2 ∈ ℝ\",\"Kierunek nierówności odwrócony w obie strony.\"],\"duration\":29.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"0<a<1,\\\\quad x<y\",\"label\":\"Warunek: podstawa między zerem a jedynką\"},{\"formula\":\"a^x>a^y\",\"label\":\"Potęgowanie odwraca porządek\"},{\"formula\":\"1^x=1\",\"label\":\"Podstawa jeden jest przypadkiem osobnym\"}]}")


class Generic_theory_formula_2(LessonScene):
