...
DATA = json.loads("{\"tag\":\"DEFINICJA\",\"title\":\"Monotoniczność potęgowania względem wykładnika\",\"lines\":[\"Przy ustalonej podstawie a > 0, a ≠ 1, porównanie potęg a^{x_1} i\",\"czy a > 1, czy 0 < a < 1.\",\"To jest sedno tematu: podstawa decyduje o 'kierunku'. Dla a > 1\"],\"duration\":32.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"2^0=1,\\\\quad2^1=2,\\\\quad2^2=4\",\"label\":\"Wykładnik rośnie, wartość rośnie\"},{\"formula\":\"-3<-2\",\"label\":\"Porównaj wykładniki na osi\"},{\"formula\":\"2^{-3}<2^{-2}\",\"label\":\"Kierunek pozostaje taki sam\"}]}")


class Generic_theory_concept_3(LessonScene):
