...
DATA = json.loads("{\"tag\":\"PRZYKŁAD 1\",\"title\":\"Porównaj potęgi o tej samej podstawie\",\"lines\":[\"Porównaj liczby w każdej z par. W każdym podpunkcie wpisz między\",\"liczbami znak < albo >. (a) 7^{-3} i 7^{-2}. (b)\",\"\\\\left(\\\\frac{2}{5}\\\\right)^{4} i \\\\left(\\\\frac{2}{5}\\\\right)^{7}.\"],\"duration\":31.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"-3<-2\\\\Rightarrow7^{-3}<7^{-2}\",\"label\":\"Siedem: zachowaj kierunek\"},{\"formula\":\"0<\\\\frac25<1,\\\\quad4<7\",\"label\":\"Dwie piąte: odwróć kierunek\"},{\"formula\":\"\\\\left(\\\\frac25\\\\right)^4>\\\\left(\\\\frac25\\\\right)^7\",\"label\":\"Pierwsza potęga jest większa\"}]}")


class Generic_example_g_th_00(LessonScene):
