...
DATA = json.loads("{\"tag\":\"HAK\",\"title\":\"Monotoniczność potęgowania\",\"lines\":[\"Temat: Monotoniczność potęgowania\",\"and reversed for base in (0, 1); comparing and estimating powers.\",\"Cel: rozpoznać narzędzie, wykonać rachunek, sprawdzić odpowiedź.\"],\"duration\":30.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"7^{-3}\\\\;?\\\\;7^{-2}\",\"label\":\"Ta sama podstawa, różne wykładniki\"},{\"formula\":\"\\\\left(\\\\frac25\\\\right)^4\\\\;?\\\\;\\\\left(\\\\frac25\\\\right)^7\",\"label\":\"Czy dla ułamka działa ten sam kierunek?\"},{\"formula\":\"a>1\\\\quad\\\\text{lub}\\\\quad0<a<1\",\"label\":\"Najpierw sprawdź podstawę\"}]}")
