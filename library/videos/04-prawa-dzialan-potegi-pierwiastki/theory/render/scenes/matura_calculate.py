...
DATA = json.loads("{\"tag\":\"MATURA\",\"title\":\"Policz składniki osobno\",\"lines\":[\"Potęgi o wykładnikach ułamkowych, ujemnych i zerowych\"],\"duration\":49.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"\\\\left(\\\\frac19\\\\right)^{-\\\\frac12}=9^{\\\\frac12}=3\",\"label\":\"Pierwszy składnik daje trzy\"},{\"formula\":\"32=2^5\",\"label\":\"Trzydzieści dwa zapisz jako potęgę dwójki\"},{\"formula\":\"32^{\\\\frac25}=(2^5)^{\\\\frac25}=2^2=4\",\"label\":\"Drugi składnik daje cztery\"}]}")


class Generic_matura_calculate(LessonScene):
