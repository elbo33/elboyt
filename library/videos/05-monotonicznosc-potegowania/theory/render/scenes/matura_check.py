...
DATA = json.loads("{\"tag\":\"MATURA\",\"title\":\"Sprawdź kierunek nierówności\",\"lines\":[\"Porównanie potęg o wspólnej podstawie\"],\"duration\":31.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"27^{10}<9^{16}\",\"label\":\"Większa jest druga liczba\"},{\"formula\":\"27^{10}=3^{30},\\\\quad9^{16}=3^{32}\",\"label\":\"Sprawdź oba przekształcenia\"},{\"formula\":\"3>1\\\\Rightarrow30<32\",\"label\":\"Znak wynika z rosnącej potęgi\"}]}")


class Generic_matura_check(LessonScene):
