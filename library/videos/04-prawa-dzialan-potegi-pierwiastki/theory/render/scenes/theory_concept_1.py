...
DATA = json.loads("{\"tag\":\"DEFINICJA\",\"title\":\"Potęga o wykładniku naturalnym\",\"lines\":[\"Dla liczby rzeczywistej a i liczby naturalnej n ≥ 1: aⁿ = a·a·…·a (n\",\"czynników). Liczbę a nazywamy podstawą, n , wykładnikiem.\",\"To najprostsza sytuacja: potęgowanie jest skróconym zapisem mnożenia\"],\"duration\":16.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"a^3=a\\\\cdot a\\\\cdot a\",\"label\":\"Ta sama podstawa, trzy czynniki\"},{\"formula\":\"2^4=2\\\\cdot2\\\\cdot2\\\\cdot2\",\"label\":\"Wykładnik mówi, ile razy mnożymy\"},{\"formula\":\"2^4=16\",\"label\":\"Tak powstaje wartość potęgi\"}]}")
