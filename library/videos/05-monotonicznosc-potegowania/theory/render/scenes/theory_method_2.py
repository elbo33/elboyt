...
DATA = json.loads("{\"tag\":\"DEFINICJA\",\"title\":\"Sprowadzanie do wspólnej podstawy\",\"lines\":[\"ale wszystkie są potęgami jednej liczby, np. 1/9, 3, 27, 81.\",\"• Zapisz każdą podstawę jako a^k (np. 8 = 2^3, 1/4 = 2^{-2}).\",\"• Zastosuj wzór (a^k)^x = a^{kx} i uprość wykładniki.\"],\"duration\":29.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"1=a^0\\\\quad(a>0)\",\"label\":\"Zapisz jedynkę jako potęgę\"},{\"formula\":\"2^{-1}<2^0=1\",\"label\":\"Przy podstawie większej od jedynki\"},{\"formula\":\"\\\\left(\\\\frac12\\\\right)^{-1}>\\\\left(\\\\frac12\\\\right)^0=1\",\"label\":\"Przy ułamku kierunek się odwraca\"}]}")
