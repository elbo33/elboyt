...
DATA = json.loads("{\"tag\":\"PODSUMOWANIE\",\"title\":\"Podsumowanie\",\"lines\":[\"Najpierw: rozpoznaj typ zadania.\",\"Potem: wybierz wzór, własność albo metodę.\",\"Na końcu: policz i sprawdź sens wyniku.\"],\"duration\":39.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"a>1:\\\\;x<y\\\\Rightarrow a^x<a^y\",\"label\":\"Powyżej jedynki: zachowaj kierunek\"},{\"formula\":\"0<a<1:\\\\;x<y\\\\Rightarrow a^x>a^y\",\"label\":\"Poniżej jedynki: odwróć kierunek\"},{\"formula\":\"1=a^0\",\"label\":\"Porównuj z jedynką przez wykładnik zero\"},{\"formula\":\"\\\\checkmark\",\"label\":\"Zasubskrybuj i zaproponuj kolejny temat\"}]}")
