...
DATA = json.loads("{\"tag\":\"MATURA\",\"title\":\"Zadanie w stylu maturalnym\",\"lines\":[\"Potęgi o wykładnikach ułamkowych, ujemnych i zerowych\"],\"duration\":50.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"\\\\left(\\\\frac19\\\\right)^{-\\\\frac12}+32^{\\\\frac25}-7^0\",\"label\":\"Trzy składniki, trzy krótkie rachunki\"},{\"formula\":\"\\\\left(\\\\frac19\\\\right)^{-\\\\frac12}\",\"label\":\"Ujemny wykładnik: pomyśl o odwrotności\"},{\"formula\":\"32^{\\\\frac25}\\\\qquad 7^0\",\"label\":\"Wspólna podstawa i wykładnik zerowy\"}]}")


class Generic_matura_setup(LessonScene):
