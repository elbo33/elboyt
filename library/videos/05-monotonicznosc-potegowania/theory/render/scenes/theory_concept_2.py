...
DATA = json.loads("{\"tag\":\"DEFINICJA\",\"title\":\"Podstawa większa od 1 — funkcja rosnąca\",\"lines\":[\"Jeśli a > 1, to dla dowolnych liczb rzeczywistych x_1 < x_2 zachodzi\",\"a^{x_1} < a^{x_2}.\",\"wykładniku przenosi się bez zmian na kolejność potęg.\"],\"duration\":30.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"a>1:\\\\quad x<y\\\\Rightarrow a^x<a^y\",\"label\":\"Podstawa większa od jedynki: rośnie\"},{\"formula\":\"0<a<1:\\\\quad x<y\\\\Rightarrow a^x>a^y\",\"label\":\"Podstawa ułamkowa: maleje\"},{\"formula\":\"2>1\\\\qquad 0<\\\\frac12<1\",\"label\":\"Dwie strony jedynki, dwa kierunki\"}]}")


class Generic_theory_concept_2(LessonScene):
