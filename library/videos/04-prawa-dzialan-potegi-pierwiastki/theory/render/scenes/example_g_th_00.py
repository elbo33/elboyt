...
DATA = json.loads("{\"tag\":\"PRZYKŁAD 1\",\"title\":\"zamiana zapisu pierwiastkowego na potęgowy\",\"lines\":[\"wymiernym.\",\"• Rozpoznaj wzór \\\\(\\\\sqrt[n]{a^{m}}=a^{\\\\frac{m}{n}}\\\\).\",\"• Podstaw \\\\(n=4\\\\), \\\\(m=3\\\\), \\\\(a=5\\\\).\"],\"duration\":26.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"\\\\sqrt[4]{5^3}\",\"label\":\"Stopień pierwiastka trafi do mianownika\"},{\"formula\":\"\\\\sqrt[n]{a^m}=a^{\\\\frac{m}{n}}\",\"label\":\"Wykładnik pod pierwiastkiem trafi do licznika\"},{\"formula\":\"\\\\sqrt[4]{5^3}=5^{\\\\frac34}\",\"label\":\"Ta sama liczba w nowej postaci\"}]}")
