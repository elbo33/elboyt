...
DATA = json.loads("{\"tag\":\"DEFINICJA\",\"title\":\"Prawa działań na potęgach\",\"lines\":[\"= aⁿbⁿ, (a/b)ⁿ = aⁿ/bⁿ.\",\"który z tych dwóch typów mamy przed sobą, jest połową sukcesu.\"],\"duration\":18.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"a^m\\\\cdot a^n=a^{m+n}\",\"label\":\"Mnożenie: dodaj wykładniki\"},{\"formula\":\"\\\\frac{a^m}{a^n}=a^{m-n}\",\"label\":\"Dzielenie: odejmij wykładniki\"},{\"formula\":\"(a^m)^n=a^{mn}\",\"label\":\"Potęga potęgi: pomnóż wykładniki\"}]}")
