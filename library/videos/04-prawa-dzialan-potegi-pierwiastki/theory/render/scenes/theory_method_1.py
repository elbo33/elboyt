...
DATA = json.loads("{\"tag\":\"DEFINICJA\",\"title\":\"Obliczanie wartości potęgi o wykładniku wymiernym\",\"lines\":[\"Kiedy: Gdy trzeba podać liczbową wartość wyrażenia typu 8^(2/3),\",\"16^(−3/4), (1/25)^(−1/2).\",\"stanowiący podstawę.\"],\"duration\":21.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"16^{\\\\frac34}\",\"label\":\"Najpierw rozpoznaj prostą podstawę\"},{\"formula\":\"(2^4)^{\\\\frac34}\",\"label\":\"Zapisz szesnaście jako potęgę dwójki\"},{\"formula\":\"2^{4\\\\cdot\\\\frac34}=2^3=8\",\"label\":\"Pomnóż wykładniki i oblicz\"}]}")


class Generic_theory_method_1(LessonScene):
