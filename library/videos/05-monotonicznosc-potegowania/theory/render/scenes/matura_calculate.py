...
DATA = json.loads("{\"tag\":\"MATURA\",\"title\":\"Sprowadź do podstawy trzy\",\"lines\":[\"Porównanie potęg o wspólnej podstawie\"],\"duration\":30.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"27^{10}=(3^3)^{10}=3^{30}\",\"label\":\"Pierwszy wykładnik: trzydzieści\"},{\"formula\":\"9^{16}=(3^2)^{16}=3^{32}\",\"label\":\"Drugi wykładnik: trzydzieści dwa\"},{\"formula\":\"30<32\\\\Rightarrow3^{30}<3^{32}\",\"label\":\"Podstawa trzy zachowuje kierunek\"}]}")
