...
DATA = json.loads("{\"tag\":\"WZÓR\",\"title\":\"Potęga o wykładniku zerowym\",\"lines\":[\"a^0 = 1\",\"a ≠ 0\",\"Symbol 0⁰ jest nieokreślony.\"],\"duration\":16.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"a^0=1\",\"label\":\"Wzór obowiązuje dla niezerowej podstawy\"},{\"formula\":\"7^0=1\",\"label\":\"Wartość nie zależy od niezerowej podstawy\"},{\"formula\":\"0^0\",\"label\":\"Zera do zera nie obliczamy tym wzorem\"}]}")
