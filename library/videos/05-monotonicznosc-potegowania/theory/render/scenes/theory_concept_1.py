...
DATA = json.loads("{\"tag\":\"DEFINICJA\",\"title\":\"Potęga o podstawie dodatniej\",\"lines\":[\"a^x, przy czym zawsze a^x > 0.\",\"Podstawę zawsze zakładamy dodatnią (i zwykle a ≠ 1), bo tylko wtedy\",\"zachowuje się 'porządnie'. Kluczowy wniosek: potęga liczby dodatniej\"],\"duration\":30.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"a>0\\\\quad\\\\Longrightarrow\\\\quad a^x>0\",\"label\":\"Dodatnia podstawa daje dodatni wynik\"},{\"formula\":\"2^{-3}=\\\\frac1{2^3}=\\\\frac18\",\"label\":\"Minus w wykładniku oznacza odwrotność\"},{\"formula\":\"a^0=1\\\\quad(a>0)\",\"label\":\"Jedynka jest punktem odniesienia\"}]}")


class Generic_theory_concept_1(LessonScene):
