...
DATA = json.loads("{\"tag\":\"WZÓR\",\"title\":\"Monotoniczność dla podstawy a > 1\",\"lines\":[\"a>1 \\\\;\\\\Longrightarrow\\\\; \\\\big(x_1<x_2 \\\\iff a^{x_1}<a^{x_2}\\\\big)\",\"a > 1, x_1, x_2 ∈ ℝ\",\"Kierunek nierówności zachowany w obie strony.\"],\"duration\":29.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"a>1,\\\\quad x<y\",\"label\":\"Warunek: podstawa większa od jedynki\"},{\"formula\":\"a^x<a^y\",\"label\":\"Potęgowanie zachowuje porządek\"},{\"formula\":\"5^{x-2}<5^6\\\\Rightarrow x-2<6\",\"label\":\"Tak użyjesz reguły w nierówności\"}]}")


class Generic_theory_formula_1(LessonScene):
