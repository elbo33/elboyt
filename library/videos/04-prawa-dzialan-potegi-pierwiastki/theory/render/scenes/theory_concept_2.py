...
DATA = json.loads("{\"tag\":\"DEFINICJA\",\"title\":\"Potęga o wykładniku 0 i o wykładniku całkowitym ujemnym\",\"lines\":[\"Dla a ≠ 0 przyjmujemy a⁰ = 1 oraz a⁻ⁿ = 1/aⁿ dla n naturalnego\",\"dodatniego. Wyrażenie 0⁰ oraz 0⁻ⁿ nie są określone.\",\"nie oznacza liczby ujemnej , oznacza odwrotność.\"],\"duration\":25.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"\\\\frac{a^m}{a^m}=1\",\"label\":\"Dzielimy tę samą liczbę przez siebie\"},{\"formula\":\"a^{m-m}=a^0=1\",\"label\":\"Podstawa musi być różna od zera\"},{\"formula\":\"a^{-n}=\\\\frac{1}{a^n}\",\"label\":\"Ujemny wykładnik daje odwrotność\"}]}")
