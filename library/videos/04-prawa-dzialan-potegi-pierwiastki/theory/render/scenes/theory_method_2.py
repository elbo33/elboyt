...
DATA = json.loads("{\"tag\":\"DEFINICJA\",\"title\":\"Upraszczanie wyrażenia potęgowego przez sprowadzenie do wspólnej podstawy\",\"lines\":[\"Kiedy: Gdy w iloczynie/ilorazie występują liczby będące potęgami tej\",\"potęgach.\",\"• Każdy czynnik zapisz jako potęgę wspólnej podstawy a.\"],\"duration\":27.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"8=2^3\\\\qquad4=2^2\",\"label\":\"Różne liczby mogą mieć wspólną podstawę\"},{\"formula\":\"\\\\frac{2^7\\\\cdot2^{-3}}{2^2}\",\"label\":\"Najpierw uporządkuj licznik\"},{\"formula\":\"2^{7-3-2}=2^2\",\"label\":\"Dodaj i odejmij wykładniki\"}]}")


class Generic_theory_method_2(LessonScene):
