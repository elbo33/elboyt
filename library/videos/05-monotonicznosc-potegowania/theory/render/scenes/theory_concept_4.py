...
DATA = json.loads("{\"tag\":\"DEFINICJA\",\"title\":\"Podstawa z przedziału (0, 1) — funkcja malejąca\",\"lines\":[\"a^{x_1} > a^{x_2}.\",\"większy wykładnik, tym mniejsza potęga. Przy przechodzeniu od\",\"nierówności wykładników do nierówności potęg (i odwrotnie) trzeba\"],\"duration\":29.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"\\\\left(\\\\frac12\\\\right)^1=\\\\frac12\",\"label\":\"Mnożenie przez ułamek zmniejsza liczbę\"},{\"formula\":\"\\\\left(\\\\frac12\\\\right)^2=\\\\frac14\",\"label\":\"Większy wykładnik, mniejszy wynik\"},{\"formula\":\"1<2\\\\quad\\\\text{lecz}\\\\quad\\\\frac12>\\\\frac14\",\"label\":\"Kierunek nierówności się odwraca\"}]}")


class Generic_theory_concept_4(LessonScene):
