...
DATA = json.loads("{\"tag\":\"DEFINICJA\",\"title\":\"Pierwiastek arytmetyczny stopnia n\",\"lines\":[\"jedyną liczbę b ≥ 0, dla której bⁿ = a. Zapis: b = ⁿ√a. Dla n = 2\",\"piszemy √a.\",\"Kluczowe jest słowo 'nieujemna': √16 = 4, a nie ±4. Symbol √ oznacza\"],\"duration\":16.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"\\\\sqrt{16}=4\",\"label\":\"Pierwiastek kwadratowy jest nieujemny\"},{\"formula\":\"4^2=16\",\"label\":\"Sprawdź wynik przez potęgowanie\"},{\"formula\":\"\\\\sqrt{x^2}=|x|\",\"label\":\"Dla ujemnego x potrzebna jest wartość bezwzględna\"}]}")
