...
DATA = json.loads("{\"tag\":\"MATURA\",\"title\":\"Złóż wynik i sprawdź\",\"lines\":[\"Potęgi o wykładnikach ułamkowych, ujemnych i zerowych\"],\"duration\":50.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"7^0=1\",\"label\":\"Trzeci składnik daje jeden\"},{\"formula\":\"3+4-1=6\",\"label\":\"Wróć do działań z polecenia\"},{\"formula\":\"\\\\left(\\\\frac19\\\\right)^{-\\\\frac12}+32^{\\\\frac25}-7^0=6\",\"label\":\"Sprawdź znaki i zaznacz odpowiedź\"}]}")
