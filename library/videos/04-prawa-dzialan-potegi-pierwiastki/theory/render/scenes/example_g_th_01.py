...
DATA = json.loads("{\"tag\":\"PRZYKŁAD 2\",\"title\":\"obliczanie potęgi o wykładniku wymiernym\",\"lines\":[\"Oblicz wartość wyrażenia \\\\(16^{\\\\frac{3}{4}}\\\\).\",\"• Zapisz podstawę jako potęgę liczby pierwszej: \\\\(16=2^{4}\\\\).\",\"• Zastosuj wzór \\\\(\\\\left(a^{m}\\\\right)^{n}=a^{m\\\\cdot n}\\\\):\"],\"duration\":26.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"16^{\\\\frac34}\",\"label\":\"Zacznij od zapisania podstawy\"},{\"formula\":\"(2^4)^{\\\\frac34}=2^{4\\\\cdot\\\\frac34}\",\"label\":\"W potędze potęgi mnożymy wykładniki\"},{\"formula\":\"2^3=8\",\"label\":\"Ostateczny wynik\"}]}")


class Generic_example_g_th_01(LessonScene):
