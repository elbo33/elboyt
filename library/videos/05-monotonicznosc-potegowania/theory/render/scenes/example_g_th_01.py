...
DATA = json.loads("{\"tag\":\"PRZYKŁAD 2\",\"title\":\"Porównaj potęgi z jedynką\",\"lines\":[\"jest ona większa od 1: (a) \\\\left(\\\\frac{3}{4}\\\\right)^{-6}, (b)\",\"\\\\left(0{,}9\\\\right)^{5}, (c) 2^{-0{,}3}.\",\"Szukane: (a), (b), (c)\"],\"duration\":31.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"\\\\left(\\\\frac34\\\\right)^{-6}>1\",\"label\":\"Ujemny wykładnik przy ułamku: tak\"},{\"formula\":\"(0{,}9)^5<1\",\"label\":\"Dodatni wykładnik przy ułamku: nie\"},{\"formula\":\"2^{-0{,}3}<2^0=1\",\"label\":\"Ujemny wykładnik przy dwójce: nie\"}]}")
