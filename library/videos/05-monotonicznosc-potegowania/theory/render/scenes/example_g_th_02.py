...
DATA = json.loads("{\"tag\":\"PRZYKŁAD 3\",\"title\":\"Rozwiąż nierówność wykładniczą\",\"lines\":[\"Rozwiąż nierówność 5^{x-2} < 5^{6}. Zbiór rozwiązań zapisz w postaci\",\"przedziału.\",\"• Zauważ, że obie strony mają tę samą podstawę 5 i że 5 > 1.\"],\"duration\":33.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"5^{x-2}<5^6\",\"label\":\"Podstawa pięć jest większa od jedynki\"},{\"formula\":\"x-2<6\\\\Rightarrow x<8\",\"label\":\"Zachowaj znak i rozwiąż nierówność\"},{\"formula\":\"x\\\\in(-\\\\infty,8)\",\"label\":\"Ósemka nie należy do przedziału\"}]}")


class Generic_example_g_th_02(LessonScene):
