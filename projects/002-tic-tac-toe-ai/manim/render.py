...
— paths are resolved relative to this file):
    ...
    python render.py --scene title_card         # one scene, every language
    python render.py --scene title_card --lang en,fr
    python render.py --scene title_card --lang en --quality h
"""
