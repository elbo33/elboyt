...
DATA = json.loads("{\"tag\":\"DEFINICJA\",\"title\":\"Porównywanie dwóch potęg o tej samej podstawie\",\"lines\":[\"a > 0, a ≠ 1.\",\"• Porównaj wykładniki p i q (uwaga na ułamki, liczby ujemne i\",\"niewymierne).\"],\"duration\":29.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"a^x\\\\;?\\\\;a^y\",\"label\":\"Sprawdź, czy podstawy są takie same\"},{\"formula\":\"a>1\\\\quad\\\\text{czy}\\\\quad0<a<1\",\"label\":\"Ustal położenie podstawy względem jedynki\"},{\"formula\":\"27=3^3,\\\\quad9=3^2\",\"label\":\"Różne podstawy można czasem uwspólnić\"}]}")
