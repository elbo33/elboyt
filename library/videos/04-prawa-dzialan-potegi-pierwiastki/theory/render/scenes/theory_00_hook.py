...
DATA = json.loads("{\"tag\":\"HAK\",\"title\":\"Prawa działań na potęgach i pierwiastkach\",\"lines\":[\"Temat: Prawa działań na potęgach i pierwiastkach\",\"Zakres: Rational exponents and the root-power link; the laws for\",\"multiplying, dividing and raising powers, and their counterparts for\"],\"duration\":33.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"a^m\\\\cdot a^n=a^{m+n}\",\"label\":\"Jedna podstawa, dodaj wykładniki\"},{\"formula\":\"\\\\sqrt[n]{a^m}=a^{\\\\frac{m}{n}}\",\"label\":\"Pierwiastek też można zapisać jako potęgę\"},{\"formula\":\"16^{\\\\frac34}=8\",\"label\":\"Za chwilę zobaczysz, skąd bierze się wynik\"}]}")


class Generic_theory_00_hook(LessonScene):
