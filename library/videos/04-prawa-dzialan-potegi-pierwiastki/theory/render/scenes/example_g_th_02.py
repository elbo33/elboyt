...
DATA = json.loads("{\"tag\":\"PRZYKŁAD 3\",\"title\":\"prawa działań na potęgach\",\"lines\":[\"potęgi liczby 2 oraz oblicz jego wartość.\",\"Szukane: postać potęgowa, wartość\",\"• W liczniku dodaj wykładniki: \\\\(2^{7}\\\\cdot 2^{-3}=2^{4}\\\\).\"],\"duration\":26.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"\\\\frac{2^7\\\\cdot2^{-3}}{2^2}\",\"label\":\"Wszystkie potęgi mają podstawę dwa\"},{\"formula\":\"\\\\frac{2^{7-3}}{2^2}=\\\\frac{2^4}{2^2}\",\"label\":\"W liczniku dodaj wykładniki\"},{\"formula\":\"2^{4-2}=2^2=4\",\"label\":\"Przy dzieleniu odejmij wykładnik\"}]}")
