...
DATA = json.loads("{\"tag\":\"MATURA\",\"title\":\"Porównaj dwie potęgi\",\"lines\":[\"Porównanie potęg o wspólnej podstawie\"],\"duration\":33.7,\"visualKind\":\"formula\",\"steps\":[{\"formula\":\"27^{10}\\\\;?\\\\;9^{16}\",\"label\":\"Nie licz ogromnych wartości\"},{\"formula\":\"27=3^3\",\"label\":\"Pierwsza podstawa to potęga trójki\"},{\"formula\":\"9=3^2\",\"label\":\"Druga podstawa też jest potęgą trójki\"}]}")
