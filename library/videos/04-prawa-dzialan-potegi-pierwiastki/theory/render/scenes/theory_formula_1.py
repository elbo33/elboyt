...
DATA = json.loads("{\"tag\":\"WZÓR\",\"title\":\"Definicja potęgi o wykładniku naturalnym\",\"lines\":[\"a^n = \\\\underbrace{a\\\\cdot a\\\\cdot\\\\ldots\\\\cdot a}_{n\\\\ \\\\text{czynników}}\",\"a ∈ ℝ, n ∈ ℕ, n ≥ 1\"],\"duration\":16.7,\"visualKind\":\"board\",\"steps\":[{\"formula\":\"a^n=\\\\underbrace{a\\\\cdot\\\\ldots\\\\cdot a}_{n}\",\"label\":\"Wykładnik liczy czynniki\"},{\"formula\":\"a^2\\\\cdot a^3\",\"label\":\"Razem jest pięć takich samych czynników\"},{\"formula\":\"a^2\\\\cdot a^3=a^5\",\"label\":\"Stąd bierze się dodawanie wykładników\"}]}")
